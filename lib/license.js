...
(function () {
   ...
   * productId is the product permalink from your Gumroad product URL,
   * e.g. https://gumroad.com/l/aiexpor → productId 'aiexpor'
   */
  const GUMROAD = {
    productId: 'AsGOrOJwjazTMpRSf3I4JA==',
    ...
    storeUrl: 'https://bksy555.gumroad.com/l/aiexpor'
  };
